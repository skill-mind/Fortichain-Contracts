...
pub trait IFortichain<TContractState> {
    ...
    fn get_researcher_projects_report(self: @TContractState)-> Array<Report>; // only resercher can make report researcher report 
    fn get_researcher_projects_report_by_id(self: @TContractState, id:u256)-> Report; // caller research 
